...
void Cor__acc_step(int frontDistance, int leftDiistance, int leftOut,
  ...
  Cor__frontDistanceToSpeed_out Cor__frontDistanceToSpeed_out_st;
  ...
  Cor__frontDistanceToSpeed_step(frontDistance,
                                 &Cor__frontDistanceToSpeed_out_st);
  v_15 = Cor__frontDistanceToSpeed_out_st.speed;
  ...
  Cor__frontDistanceToSpeed_step(frontDistance,
                                 &Cor__frontDistanceToSpeed_out_st);
  v_3 = Cor__frontDistanceToSpeed_out_st.speed;
  v = (centreOut==false);
  if (v) {
    _out->wheelLeft = v_3;
  } else {
